...
INSERT INTO orders (customer_id, asset_name, order_side, size, price, status, create_date) VALUES (1, 'AAPL', 'BUY', 10, 200, 'PENDING', CURRENT_TIMESTAMP);

-- Customer 1: CANCELED SELL order (restored 5 AAPL)
INSERT INTO orders (customer_id, asset_name, order_side, size, price, status, create_date) VALUES (1, 'AAPL', 'SELL', 5, 210, 'CANCELLED', CURRENT_TIMESTAMP);

-- Customer 2: MATCHED SELL order (received 1000 TRY)
INSERT INTO orders (customer_id, asset_name, order_side, size, price, status, create_date) VALUES (2, 'TSLA', 'SELL', 5, 200, 'MATCHED', CURRENT_TIMESTAMP);
